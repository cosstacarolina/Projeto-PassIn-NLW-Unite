...
public class EventController{
    ...
    public ResponseEntity<AttendeeIdDTO> resgisterParticipant(@PathVariable String eventId, @RequestBody AttendeeRequestDTO body, UriComponentsBuilder uriComponentsBuilder){
